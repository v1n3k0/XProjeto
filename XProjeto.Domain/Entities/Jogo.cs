...
using XProjeto.Domain.Entities.Base;
    ...
    public class Jogo: EntityBase
    {
        ...
        private void ValidarEntidade()
        {
            new AddNotifications<Jogo>(this)
                ...
                .IfNullOrInvalidLength(x => x.Descricao, 1, 255, Message.X0_OBRIGATORIA_E_DEVE_CONTER_ENTRE_X1_E_X2_CARACTERES.ToFormat("Descrição", "1", "255"))
